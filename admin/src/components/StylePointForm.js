...
const StylePointForm = () => {
  ...
  const fetchStylePoints = async () => {
    try {
      // HTTP GET 요청
      const response = await axios.get('https://d6b41482-cbdb-4dd1-b116-c0596494faf2.mock.pstmn.io/admin/stylepoints');
  ...
  const fetchStylePointDetails = async (id) => {
    try {
      // HTTP GET 요청
      const response = await axios.get(`https://d6b41482-cbdb-4dd1-b116-c0596494faf2.mock.pstmn.io/admin/stylepoint/${id}`); // 업데이트된 상대 경로
  ...
  const updateStylePoint = async () => {
    try {
      ...
      // HTTP PUT 요청
      const response = await axios.put(`https://d6b41482-cbdb-4dd1-b116-c0596494faf2.mock.pstmn.io/admin/stylepoint/${selectedStylePoint.id}`, {
